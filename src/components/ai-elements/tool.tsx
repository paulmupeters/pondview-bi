...
function getStatusLabel(state: ToolState): string {
...
function getStatusIcon(state: ToolState): ReactNode {
...
export const ToolHeader = ({
  ...
  >
    <div className="flex items-center gap-2">
      ...
      <Badge className="gap-1.5 rounded-full text-xs" variant="ghost">
        {getStatusIcon(state)}
