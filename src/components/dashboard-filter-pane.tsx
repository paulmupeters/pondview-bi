    ...
    <div className="space-y-6">
      ...
      {filters.length > 0 && (
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <label htmlFor="active-filters" className="text-sm font-medium">
              Active Filters
            </label>
            <Button
              variant="ghost"
      ...
      {availableDimensions.length === 0 && (
        <p className="text-sm italic text-muted-foreground">
          No filterable dimensions available. Charts need detectable table
          references to enable dashboard filtering.
        </p>
      )}
    </div>
  );
