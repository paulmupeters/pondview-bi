...
1. Start with [Getting Started](/introduction/getting-started).
2. Review [AI Provider Configuration](/introduction/ai-provider-configuration) and [SQL Runtime Backends](/introduction/sql-runtime-backends).
3. Add data with [Connected Data Sources](/introduction/connected-data-sources) and [Uploads and Browser Storage](/introduction/uploads-and-browser-storage).
4. Build reusable views with [Dashboards](/guide/dashboards).
5. Understand state management in [Workspace Persistence](/introduction/workspace-persistence).
