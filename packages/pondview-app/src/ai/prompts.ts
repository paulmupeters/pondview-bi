...
- For chart axis mapping, 'xKey' is the grouping/category/time dimension and 'yKeys' are numeric measures or aggregates. Numeric dimensions are still dimensions: for example, a query grouped by 'year' with 'unicorn_count' must use year on X and unicorn_count on Y.
